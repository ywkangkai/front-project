                ...
                <el-form ref="form" :rules="rules" :model="form" label-width="100px">
                    ...
                    <el-form-item label="选择项目" prop="project_id">
                        <el-select v-model="form.project_id" placeholder="请选择" @change="getInterfacesByProjectID(form.project_id)">
                            <el-option v-for="(item, key) in project_names" :key="key" :label="item.projectname" :value="item.id">
                            </el-option>
                        </el-select>
                    </el-form-item>
...
<script>
    ...
    import { addTestsuite, projects_names, interfaces_by_project_id} from '../api/api';
